...
so a cold cache still spends the usual Nominatim/OSRM calls — a repeat
request for the same route/locations is free only while the relevant
versioned cache entries are still warm and unexpired.
